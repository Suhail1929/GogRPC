...
type StringServiceClient interface {
	SendString(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*StringResponse, error)
}
...
func (c *stringServiceClient) SendString(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*StringResponse, error) {
	out := new(StringResponse)
	err := c.cc.Invoke(ctx, "/StringService/SendString", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StringServiceServer interface {
	SendString(context.Context, *StringRequest) (*StringResponse, error)
...
func (UnimplementedStringServiceServer) SendString(context.Context, *StringRequest) (*StringResponse, error) {
...
func _StringService_SendString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/StringService/SendString",
	}
